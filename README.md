...
- [FiltersHeroes/KADhosts](https://github.com/FiltersHeroes/KADhosts) - Wersja hosts, PiHole, dnsmasq, domenowa (Forti Guard) filtrów KAD
...
- [ltratt/hk](https://github.com/ltratt/hk) - hk: Set temporary X11 hotkeys
...
- [aligrudi/dblp](https://github.com/aligrudi/dblp) - Convert DBLP search results to refer records
- [CarlosDerSeher/esp_snapserver](https://github.com/CarlosDerSeher/esp_snapserver) - 
- [Wikinaut/paperback-cli](https://github.com/Wikinaut/paperback-cli) - (C) Relatively high density file backups on paper. Cross-platform CLI port of Ollydb. This is a repo copy and fork of https://git.teknik.io/scuti/paperback-cli by Surkeh.
- [simbake/Openwrt-21.02-TL-WR840N-6.2](https://github.com/simbake/Openwrt-21.02-TL-WR840N-6.2) - 
- [kyx0r/nextvi](https://github.com/kyx0r/nextvi) - A small vi/ex terminal text editor (neatvi rewrite)
...
- [dreirund/Handsomemod-uf896](https://github.com/dreirund/Handsomemod-uf896) - PROJECT IS ARCHIVED SINCE I NO LONGER HAVE A WORKING HARDWARE || A fork of OpenWrt-based "Handsomemod" operating system targeted to the ["UF896" stick-format WiFi/LTE router](https://forum.openwrt.org
- [leonmavr/retrocube](https://github.com/leonmavr/retrocube) - 📺👽 3D voxel graphics engine on the terminal in standard C without third parties
...
- [telescope-browser/telescope](https://github.com/telescope-browser/telescope) - browser for the small internet
...
- [jcorporation/myGPIOd](https://github.com/jcorporation/myGPIOd) - myGPIOd is a lightweight GPIO controlling framework based on libgpiod2.
...
- [coreboot/chrome-ec](https://github.com/coreboot/chrome-ec) - Read-only mirror of https://chromium.googlesource.com/chromiumos/platform/ec. We don't handle pull requests.
...
- [aluzzardi/pam_usb](https://github.com/aluzzardi/pam_usb) - Hardware authentication for Linux using ordinary USB Flash Drives.
...
- [Nicholas3388/LuaNode](https://github.com/Nicholas3388/LuaNode) - Lua sdk for Esp32/Esp32c2/Esp32c3/Esp32c6/Esp8266/STM32L4
...
- [landonr/homeThing](https://github.com/landonr/homeThing) - Wifi Smart Home Remotes that run on ESPHome
...
- [lighterowl/dcue](https://github.com/lighterowl/dcue) - DCue is a tool for generating CUE sheets from Discogs data.
...
- [happytm/BatteryNode](https://github.com/happytm/BatteryNode) - Simplest DIY low power, low cost, standalone or web connected  IOT sensors network framework using ESP32 or ESP8266 (no third party service required).
...
- [nRF24/RF24Network](https://github.com/nRF24/RF24Network) - OSI Layer 3 Networking for nRF24L01(+) and nRF52x on Arduino and Raspberry Pi
...
- [yanyiwu/libcppjieba](https://github.com/yanyiwu/libcppjieba) - The simple header file library of CppJieba
...
- [fotowall/fotowall](https://github.com/fotowall/fotowall) - Pictures collage & creativity tool
...
- [mamantoha/cryMPD](https://github.com/mamantoha/cryMPD) - A minimalistic web-based MPD client
- [masukomi/oho](https://github.com/masukomi/oho) - oho: converts colorful terminal output to html
...
- [Zverik/every_door](https://github.com/Zverik/every_door) - A dedicated app for collecting thousands of POI for OpenStreetMap
...
- [MKme/Wemos-D1-ESP8266-PIR-Alarm](https://github.com/MKme/Wemos-D1-ESP8266-PIR-Alarm) - Simple Web Alerting Motion Alarm using Espressif ESP8266 and IFTTT
...
- [hauke96/wiki2book](https://github.com/hauke96/wiki2book) - A simple CLI tool to create good-looking eBooks from Wikipedia articles.
...
- [ferdinandyb/maildir-rank-addr](https://github.com/ferdinandyb/maildir-rank-addr) - Creates a ranked list of email addresses from local email files, which can be used for address completion for example in aerc.
...
- [trovu/trovu.github.io](https://github.com/trovu/trovu.github.io) - Only redirects to homepage.
...
- [jpneto/r](https://github.com/jpneto/r) - RStudio Markdowns about R, Math, Stats, and ML
...
- [rufuspollock-okfn/bibjson](https://github.com/rufuspollock-okfn/bibjson) - BibJSON spec and website
...
- [Cybernetic1/conceptual-keyboard-v1_bad](https://github.com/Cybernetic1/conceptual-keyboard-v1_bad) - Conceptual Keyboard
...
- [mhwombat/pandoc-columns](https://github.com/mhwombat/pandoc-columns) - Pandoc filter to handle columns in Markdown.
...
- [Factual0367/Break-Down-Walls](https://github.com/Factual0367/Break-Down-Walls) - Firefox extension to allow easier access to information.
- [gchenfc/sci-hub-now](https://github.com/gchenfc/sci-hub-now) - Free access to academic papers with just a single click! Abolish publishers, long live the open access movement! 🦅
- [aokellermann/nexus-now](https://github.com/aokellermann/nexus-now) - Access scientific literature in your browser using standard template construct, an IPFS-backed website for nexus search.
- [zotero/translate](https://github.com/zotero/translate) - Browser standalone zotero translator
...
- [FireMarshmellow/Spotlight_Storage](https://github.com/FireMarshmellow/Spotlight_Storage) - MIMOSA - short for "Mellow_Labs Inventory Management and Organization System Apparatus". Just like a refreshing mimosa, this system will make your life brighter and more organized!
...
- [BatteredBunny/farside-redirect](https://github.com/BatteredBunny/farside-redirect) - Unofficial Farside redirect userscript
...
- [spcask/10kbclub](https://github.com/spcask/10kbclub) - A curated collection of websites whose home pages do not exceed 10 KB compressed size
...
- [rufuspollock-okfn/textus-viewer](https://github.com/rufuspollock-okfn/textus-viewer) - A sophisticated HTML-based viewer for texts
...
- [rufuspollock-okfn/textus](https://github.com/rufuspollock-okfn/textus) - A toolbox and web application for working with and presenting textual material from Shakespeare to Schopenhauer, and letters to literature.
...
- [rufuspollock-okfn/facetview](https://github.com/rufuspollock-okfn/facetview) - FacetView is a pure javascript frontend for ElasticSearch.
...
- [ralph-irving/jivelite](https://github.com/ralph-irving/jivelite) - Community Lyrion Music Server control application
...
- [uwni/ruby-typ](https://github.com/uwni/ruby-typ) - a library to implement ruby for typst language
- [yokoffing/filterlists](https://github.com/yokoffing/filterlists) - Collection of blocklists to fill in the gaps
- [zotero/zotero-bits](https://github.com/zotero/zotero-bits) - CSL-related community feedback for Zotero
...
- [unixdigest/phpthewrongway](https://github.com/unixdigest/phpthewrongway) - A pragmatic view on PHP programming.
...
- [menahishayan/TP-Link-Archer-C50-API](https://github.com/menahishayan/TP-Link-Archer-C50-API) - HTTP based python script for API access and router management of the TP-Link Archer C50
- [Kicer86/rusty_packages](https://github.com/Kicer86/rusty_packages) - A tool for identifying Arch packages that have not been used for an extended period.
...
- [galaxybrainco/alameda-data](https://github.com/galaxybrainco/alameda-data) - Queryable data for the City of Alameda
...
- [andreztz/pyradios](https://github.com/andreztz/pyradios) - Client for the Radio Browser API
...
- [SoongNoonien/plattenalbum](https://github.com/SoongNoonien/plattenalbum) - Connect to your music
...
- [volzotan/plotmap](https://github.com/volzotan/plotmap) - vector world map generator for pen plotters from OSM/shapefile/geotiff data
...
- [adbar/courlan](https://github.com/adbar/courlan) - Clean, filter and sample URLs to optimize data collection – Python & command-line – Deduplication, spam, content and language filters
...
- [jalvesaq/zotcite](https://github.com/jalvesaq/zotcite) - Neovim plugin for integration with Zotero
...
- [jdlorimer/anki-misc](https://github.com/jdlorimer/anki-misc) - Miscellaneous Anki projects
- [jdlorimer/incremental-reading](https://github.com/jdlorimer/incremental-reading) - Anki add-on providing incremental reading features
...
- [hiddewie/osm-cycling-maps](https://github.com/hiddewie/osm-cycling-maps) - Generating beatiful cycling maps using Mapnik and OpenStreetMap data
...
- [opengisch/qfieldsync](https://github.com/opengisch/qfieldsync) - Sync your projects to QField
...
- [cihai/unihan-etl](https://github.com/cihai/unihan-etl) - Export UNIHAN's database to csv, json or yaml
...
- [lourot/github-commit-watcher](https://github.com/lourot/github-commit-watcher) - :mag: Be notified on new commits on watched projects
...
- [rufuspollock-okfn/gutenizer](https://github.com/rufuspollock-okfn/gutenizer) - Get texts from Project Gutenberg, extract and format
...
- [ropensci/vcr](https://github.com/ropensci/vcr) - Record and replay HTTP requests
- [ropensci/crul](https://github.com/ropensci/crul) - R6 based http client for R (for developers)
...
- [rstudio/markdown](https://github.com/rstudio/markdown) - The first generation of Markdown rendering for R (born in 2012), based on commonmark. Note that this package is markdown, not *rmarkdown*.
...
- [pdfjam/pdfjam-extras](https://github.com/pdfjam/pdfjam-extras) - Some unsupported 'wrapper' scripts for pdfjam
...
- [glehmann/yage](https://github.com/glehmann/yage) - A simple tool to manage encrypted secrets in YAML files with age encryption 🔑
- [aartoni/gotta-fill-em-all](https://github.com/aartoni/gotta-fill-em-all) - Find every incomplete text from a set of Genius artists.
...
- [jersou/mouse-actions](https://github.com/jersou/mouse-actions) - mouse-actions execute some command from mouse events such as clicks/wheel on the side/corners of the screen, or drawing shapes. It's a mix between Easystroke and Compiz edge commands.
...
- [sofianedjerbi/Batimg](https://github.com/sofianedjerbi/Batimg) - Fast image/video printing in your terminal
...
- [gemrest/september](https://github.com/gemrest/september) - ♻️ Simple & Efficient Gemini-to-HTTP Proxy
...
- [obreitwi/asfa](https://github.com/obreitwi/asfa) - Avoid sending file attachments by uploading them via SSH to a remote site and sharing a publicly-accessible URL with non-guessable (hash-based) prefix instead.
...
- [swcarpentry/website-archive](https://github.com/swcarpentry/website-archive) - Software Carpentry website (Archive)
...
- [niqodea/tmux-matryoshka](https://github.com/niqodea/tmux-matryoshka) - Plugin for nested tmux workflows 🪆
- [hatlabs/SH-RPi-hardware](https://github.com/hatlabs/SH-RPi-hardware) - Sailor Hat for Raspberry Pi hardware design files
...
- [lynxthecat/adblock-lean](https://github.com/lynxthecat/adblock-lean) - Lean and powerful adblocking solution for OpenWrt
...
- [chirpstack/chirpstack-gateway-os](https://github.com/chirpstack/chirpstack-gateway-os) - OpenWrt based gateway images including ChirpStack components.
...
- [BawdyAnarchist/quBSD](https://github.com/BawdyAnarchist/quBSD) - A FreeBSD jails and bhyve wrapper, which implements a Qubes inspired containerization schema
...
- [brunomiguel/userrepository](https://github.com/brunomiguel/userrepository) - This project is currently in hibernation, but as of 22/08/2024, it should only need very minor adjustments, if at all, to work (excluding the subomdules pkgbuild/, as some might no longer be active)
...
- [OpenHD/OpenHD-ImageBuilder](https://github.com/OpenHD/OpenHD-ImageBuilder) - Script for building OpenHD Images
...
- [xsc/bashing](https://github.com/xsc/bashing) - Smashing Bash into Pieces | Moved to Codeberg
...
- [trovu/trovu](https://github.com/trovu/trovu) - Search 1000+ websites in a command-line way, with curated and personal shortcuts, organized by namespaces, allowing multiple and typed arguments, with maximum privacy.
...
- [benbusby/vim-hubbub](https://github.com/benbusby/vim-hubbub) - Use GitHub from within Vim/Neovim
...
- [Quill-OS/rootfs](https://github.com/Quill-OS/rootfs) - Quill OS root filesystem
...
- [j15k/colorcli](https://github.com/j15k/colorcli) - Collection of harmonized, light command-line interface (CLI) color themes for tmux, cmus, newsboat, mcabber, Vim, Vifm, and Mutt.
...
- [lambdalisue/vim-shareboard](https://github.com/lambdalisue/vim-shareboard) - A HTML viewer built for vim. Useful to see output of Pandoc or Markdown
